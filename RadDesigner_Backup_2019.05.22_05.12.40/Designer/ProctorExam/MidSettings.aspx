...
<body>
    <form id="form1" runat="server">
        ...
        <span class="auto-style1"><strong>Mid Term Proctored Exam for 
             ...
             <telerik:RadFormDecorator RenderMode="Lightweight" ID="FormDecorator1" runat="server" DecoratedControls="CheckBoxes, Textbox, Textarea, Fieldset, Label, H4H5H6, Select, Zone, GridFormDetailsViews, ValidationSummary, LoginControls" DecorationZoneID="decorationZone" Skin="Telerik"></telerik:RadFormDecorator>
...
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="Exam_ID" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <telerik:GridCheckBoxColumn DataField="PM_MG_ES" DataType="System.Boolean" FilterControlAltText="Filter PM_MG_ES column" HeaderText="Essay" SortExpression="PM_MG_ES" UniqueName="PM_MG_ES"  Visible="false">
                    </telerik:GridCheckBoxColumn>
