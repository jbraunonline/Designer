...
<body>
    ...
    <div class="auto-style1">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DesignConnectionString %>" SelectCommand="SELECT [Course], [Title], [Term87], [Term93], [Term95], [IDesg] FROM [OL_MasterPhase] WHERE ([Course] = @Course)">
            <SelectParameters>
