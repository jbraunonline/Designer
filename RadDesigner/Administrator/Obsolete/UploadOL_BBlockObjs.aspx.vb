...
Public Class UploadOL_BBlockObjs
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim fileStream As FileStream = File.Open(Server.MapPath(TextBox1.Text), FileMode.Open, FileAccess.Read)
    ...
    Protected Sub addData(ByVal text1 As String, ByVal text2 As String, ByVal text3 As String)
        Dim strSQL As String = "INSERT INTO OL_BBlock_Objects "
        strSQL += "(Pub_ID,BBName,BBObjVis) "
        strSQL += "VALUES ("
        strSQL += text1 & ",'"
        strSQL += text2 & "',"
        strSQL += text3 & ")"
