...
Public Class Add_OL_MasterProctor
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim fileStream As FileStream = File.Open(Server.MapPath("../Data/2215MasterExamDates.txt"), FileMode.Open, FileAccess.Read)
    ...
    Sub addData(ByVal strTextField0 As String, ByVal strTextField1 As String, ByVal strTextField2 As String, ByVal strTextField3 As String, ByVal strTextField4 As String, ByVal strTextField5 As String, ByVal strTextField6 As String)
        ...
        Dim strSQL As String = "INSERT INTO OL_MasterProctor (MasterName,IsMid,MidStart,MidEnd,IsFin,FinStart,FinEnd,Term,DateEntered)" &
                               "VALUES ('2215_" & strTextField0 & "_MC_VC" & 'MasterCourse
                               "'," & strTextField1 & 'isMid
        ...
        '//// no longer updating master Exam table from Ernest Burt's Exam Dates.....getting exam setting directly from MasterExam after audits.  Burt Data is unreliable.
