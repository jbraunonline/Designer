...
Public Class AddProgressData
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If dr.HasRows Then
            While dr.Read()
                MasterName = Replace(dr("MasterName"), txtLastTerm.Text & "_", txtNextTerm.Text & "_")
    ...
    Protected Sub txtLastTerm_TextChanged(sender As Object, e As EventArgs) Handles txtLastTerm.TextChanged
