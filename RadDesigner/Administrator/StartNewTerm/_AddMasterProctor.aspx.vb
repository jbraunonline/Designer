...
Public Class AddMasterProctor
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim fileStream As FileStream = File.Open(Server.MapPath("../Data/2203MasterExamDates.csv"), FileMode.Open, FileAccess.Read)
    ...
    Sub addData(ByVal strTextField0 As String, ByVal strTextField1 As String, ByVal strTextField2 As String, ByVal strTextField3 As String, ByVal strTextField4 As String, ByVal strTextField5 As String, ByVal strTextField6 As String)
        Dim mymaster As String = ""
        mymaster = txtTerm.Text & "_" & strTextField0 & "_MC_VC"
        ...
        ''''''''''''UpdateMasterExam(strTextField0, strTextField1, strTextField4)  ''Dont need to do this because ernest gets this data from the existing data for last term
        ...
        Try
            ...
            If RadioRun.SelectedValue = "Run" Then
