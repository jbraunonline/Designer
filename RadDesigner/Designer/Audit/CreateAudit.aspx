        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            ...
            <tr class="newStyle9">
                <td colspan="2" class="auto-style10">
                    ...
                    <br />
                    <asp:Label ID="lblDone" runat="server" ForeColor="#CC0000" BackColor="#FFFF66" Font-Bold="True" Font-Size="Large"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="auto-style14" colspan="2">&nbsp; <span class="auto-style9"><strong>You cannot create an audit unless you have verified the <span class="auto-style11">MasterCourse, </span> <span class="auto-style12">Building Blocks</span><span class="auto-style9">, </span></span> <span class="auto-style9">Textbook, Phase,and Exam</span></strong>&nbsp;</td>
            </tr>
            <tr>
                <td class="newStyle8">Course</td>
                <td class="newStyle2" >
                    <asp:DropDownList ID="ddlCourses" runat="server" Height="21px" Width="267px"  DataTextField="MasterName" DataValueField="MasterName" AutoPostBack="True" Font-Bold="True" >
                    </asp:DropDownList>
                &nbsp;&nbsp;
            ...
            <tr>
                ...
                &nbsp;<asp:Label ID="lblIsPrimary" runat="server" Text="1"></asp:Label>
&nbsp;<asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" Visible="False" Width="300px" Enabled="False">
    ...
    <p class="auto-style13">
        ~/Designer/Audit/CreateAudit.aspx</p>
       


        <p>
            auditcount
            <asp:Label ID="lblauditcount" runat="server" Text="Label"></asp:Label>
        </p>
