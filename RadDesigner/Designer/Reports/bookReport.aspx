...
<body>
    ...
    <div>
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticUpdates="True" AutoGenerateColumns="False"  OnItemDataBound="RadGrid1_ItemDataBound" AutoGenerateEditColumn="True" DataSourceID="SqlDataSource1" Skin="WebBlue" ShowGroupPanel="True" AllowFilteringByColumn="True" CellSpacing="-1" GridLines="Both">
