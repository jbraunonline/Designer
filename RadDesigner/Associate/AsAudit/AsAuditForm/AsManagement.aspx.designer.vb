...
Partial Public Class AsManagement
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents chkSpaces As Global.System.Web.UI.WebControls.CheckBox
    
    '''<summary>
    '''txtDateManager control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtDateManager As Global.Telerik.Web.UI.RadEditor
