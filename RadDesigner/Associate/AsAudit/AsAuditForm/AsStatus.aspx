    ...
    <form id="form1" runat="server">
        ...
        <div>
                ...
                <legend><strong>Audit Release</strong></legend>
                            <asp:Label ID="lblReleaseNotice" runat="server" BackColor="#CCFFCC" ForeColor="#993333"></asp:Label>
                            <br />
...
&nbsp;
                            ...
                            &nbsp;
                            <asp:Label ID="lblIsSweep" runat="server" BackColor="#FFFF66" Font-Bold="True" ForeColor="Maroon"></asp:Label>
                            <br />
                            &nbsp;
...
&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblAuditNo" runat="server"></asp:Label>
&nbsp;#&nbsp;
...
&nbsp;#cpl&nbsp;
    ...
    <p class="auto-style1">
        ~/Associate/AsAudit/AsAuditForm/AsStatus.aspx</p>
</body>
</html>
