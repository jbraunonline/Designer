...
Public Class AsMenu
    ...
    Protected Sub getData()
        ...
        Else
            ...
            'Dim thestatus As String = GetStatus(Session("MasterAuditName")) '2/28
    ...
    Function GetStatus(ByVal myID As Integer) As String
        ...
        Dim strsql As String
        ''strsql = "SELECT AuditStatus FROM OL_MasterAudit Where MasterName= '" & myID & "'"   '2/29
        strsql = "SELECT AuditStatus FROM OL_MasterAudit Where Audit_ID= " & Session("Audit_ID")   '2/29
