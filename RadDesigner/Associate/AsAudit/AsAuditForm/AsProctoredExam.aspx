<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AsProctoredExam.aspx.vb" Inherits="RadDesigner.AsProctoredExam" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <p>
            &nbsp;</p>
        <p class="auto-style4">
            ~/Associate/AsAudit/AsAuditForm/AsProctoredExam.aspx</p>
        <asp:Button ID="CreateExamRecord" runat="server" BorderColor="#FF5050" BorderWidth="3px" Text="Create Exam Record" Visible="False" />
    </form>
</body>
</html>
