...
Public Class ProgressReport1
    ...
    Protected Function lookupPhase(ByVal mycourse As String) As String
        Dim myColumn As String = "T_" & Session("NextTerm")
        Dim myreturn As String = ""
        Dim myConnection As New SqlConnection(ConfigurationManager.ConnectionStrings("DesignConnectionString").ConnectionString)
        Dim strsql As String
        strsql = "SELECT " & myColumn & " FROM OL_MasterPhase where Course='" & mycourse & "'"
        ...
        If dr.HasRows Then
            While dr.Read()
                If Not IsDBNull(dr("" & myColumn & "")) Then
                    Dim myvar As String
                    myreturn = dr("" & myColumn & "")
                End If
