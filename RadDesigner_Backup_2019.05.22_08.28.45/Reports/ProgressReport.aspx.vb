...
Public Class ProgressReport1
    ...
    Protected Function lookupPhase(ByVal mycourse As String) As String
        ...
        strsql = "SELECT term95  FROM OL_MasterPhase where Course='" & mycourse & "'"
        ...
        If dr.HasRows Then
            While dr.Read()
                If Not IsDBNull(dr("term95")) Then
                    Dim myvar As String
                    myreturn = dr("term95")
                End If
    ...
    Protected Function getcount(ByVal mycourse As String) As String
        ...
        Dim strsql As String
        strsql = "SELECT count (*) as thecount   FROM [VC_VCData].[dbo].[CMR]  where term = '2195' and status " & mystatus & " and type='E' and course = '" & mycourse & "'"
        'response.Write(strsql & "<br>")
        Dim myCommand As New SqlCommand(strsql, myConnection)
    ...
    Protected Function getBB(ByVal mycourse As String) As String
        ...
        strsql += "(term_key = '2195'and course = '" & mycourse & "' and  iscopytextwrite= 1) or (term_key = '2195'and course = '" & mycourse & "' and ischild = 1)"
