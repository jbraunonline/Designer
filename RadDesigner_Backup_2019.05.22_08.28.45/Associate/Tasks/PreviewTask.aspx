<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PreviewTask.aspx.vb" Inherits="RadDesigner.PreviewTask" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            ...
            <tr class="newStyle9">
                <td colspan="2">
                    <h1 class="auto-style5">Preview Task&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnReturn" runat="server" BackColor="#99FFCC" Font-Bold="True" Text="Return to My Task List" />
                    </h1>
                </td>
            </tr>
            <tr>
