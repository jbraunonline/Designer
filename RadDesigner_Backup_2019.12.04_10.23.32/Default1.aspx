...
<body>
    ...
    <div class="auto-style2">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server">
            ...
            <asp:ListItem Value="chenry1">C Henry</asp:ListItem>
            ...
            <asp:ListItem Value="althea-audit">Althea-Audit</asp:ListItem>
             <asp:ListItem Value="cheryl-audit">Cheryl-Audit</asp:ListItem>
            ...
            <asp:ListItem Value="slomena">Sandra</asp:ListItem>
        </asp:DropDownList>
                <br />
