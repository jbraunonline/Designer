...
Public Class BuildingBlockDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            LoadArray(Session("Pub_ID"), Session("MasterCourse"))
            lblPublisher.Text = "<font color-red>" & GetPublisher(Session("Pub_ID")) & "</font> Building Blocks in " & Session("MasterCourse")
    ...
    Protected Function GetPublisher(ByVal myID As String) As String
        ...
        Return myreturn
    End Function
    ''CRITICAL NOTE: in the OL_BBlock tables, the field name is MasterName when it should have been MasterCourse
    '''se we match sessionMasterCourse with the table field MasterName    ]]]]]]]]]]]]]]]]]]]->> FIX: Redo the tables using MasterCourse instead of MasterName
    ...
    Private Sub SaveCheckedItems(ByVal listBox As Telerik.Web.UI.RadListBox)
        ...
        For Each item As RadListBoxItem In collection
            Response.Write(Session("MasterCourse") & "," & CInt(Session("Pub_ID")) & "," & item.Value)
            Response.Write("<br>")
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        DeleteObjects(Session("MasterCourse"), Session("Pub_ID"))
