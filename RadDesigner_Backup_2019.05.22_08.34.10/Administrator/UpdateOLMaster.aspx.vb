...
Public Class UpdateOLMaster
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        strsql = "Select MasterCourse, Phase, Term From OL_PhaseHistory where term ='2185'"
    ...
    Public Sub UpdateData(ByVal myCourseNo As String, ByVal myTerm As String, ByVal myPhase As String)

        Dim strSQL As String = "Update OL_MasterCourse Set"



        strSQL += " Phase='" & myPhase & "'"
        strSQL += " Where MasterName = '" & myCourseNo & "'"
