...
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DesignConnectionString %>" SelectCommand="SELECT [MasterName], [Course], [Term], [Designer], [AuditStart], [AuditStatus], [AuditComplete], [Audit_ID] FROM [OL_MasterAudit] WHERE (([Term] = @Term) AND ([Auditor_ID] = @Auditor_ID))  Order By AuditStatus desc, mastername" >
            <SelectParameters>
                <asp:SessionParameter DefaultValue="2195" Name="Term" SessionField="NextTerm" Type="Int32" />
                <asp:SessionParameter DefaultValue="4" Name="Auditor_ID" SessionField="User_ID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
    </form>
</body>
