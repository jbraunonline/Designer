<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AsDualAudit.aspx.vb" Inherits="RadDesigner.AsDualAudit" %>
...
<div class="row">
  <div class="column left" style="background-color:#ffffff;">
       <p><asp:Button ID="btnReturn" runat="server" BackColor="#336699" Font-Bold="True" Font-Names="Arial" ForeColor="White" Text="Return to Audit List" Visible="False" />
        &nbsp;&nbsp;&nbsp;&nbsp;
...
        <telerik:RadPageView ID="RadPageView1" runat="server" Width="1000px" Height="800px"
                ContentUrl="~/Associate/AsAudit/AsAuditForm/AsCourse.aspx">
                   </telerik:RadPageView>
        <telerik:RadPageView ID="RadPageView2" runat="server" Width="1000px" Height="800px"
                ContentUrl="~/Associate/AsAudit/AsAuditForm/AsMenu.aspx">
        </telerik:RadPageView>
        <telerik:RadPageView ID="RadPageView3" runat="server" Width="1000px" Height="800px"
                ContentUrl="~/Associate/AsAudit/AsAuditForm/AsModules.aspx">
        </telerik:RadPageView>
         <telerik:RadPageView ID="RadPageView4" runat="server" Width="1000px" Height="800px"
                ContentUrl="~/Associate/AsAudit/AsAuditForm/ASProctoredExam.aspx">
        </telerik:RadPageView>
               <telerik:RadPageView ID="RadPageView5" runat="server" Width="1000px" Height="800px"
                 ContentUrl="~/Associate/AsAudit/AsAuditForm/AsManagement.aspx">
        </telerik:RadPageView>
        <telerik:RadPageView ID="RadPageView6" runat="server" Width="1000px" Height="800px"
