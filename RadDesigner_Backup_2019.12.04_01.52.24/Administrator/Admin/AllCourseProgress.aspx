<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AllCourseProgress.aspx.vb" Inherits="RadDesigner.AllCourseProgress" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            All Course Progress </span>
            <asp:Button ID="Button1" runat="server" BorderColor="#CC0000" BorderWidth="2px" Text="Close Window" />
            <br />
        <div>
        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" GroupPanel-Enabled="true" DataSourceID="SqlDataSource1" AllowSorting="True" Skin="WebBlue" Width="1033px" CssClass="RadGrid" AllowFilteringByColumn="True" ShowGroupPanel="True"  >
<GroupingSettings CollapseAllTooltip="Collapse all groups"    ></GroupingSettings>

            <ClientSettings AllowDragToGroup="True">
            </ClientSettings>
            <MasterTableView DataSourceID="SqlDataSource1" GroupsDefaultExpanded="False"  EnableGroupsExpandAll="true"  ShowHeader="true" GroupLoadMode="Client" >
                <Columns>
