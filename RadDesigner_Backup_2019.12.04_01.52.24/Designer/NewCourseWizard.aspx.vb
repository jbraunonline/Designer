...
Public Class NewCoourseWizard
    ...
    Protected Sub SaveCatalog()
        ...
        strsql += Replace(txtCatTitle.Text, "'", "") & "','"
        ...
        mycatalog += "Name: " & Replace(txtCatTitle.Text, "'", "") & "<br>"
    ...
    Private Sub AddNewMaster()
        ...
        addMasterProctor(lblMasterName.Text, Session("NextTerm"))
    ...
    Private Sub addMasterProctor(ByVal string0 As String, ByVal string1 As String)
        Dim mymaster As String = ""
        Dim strSQL As String = " Insert into OL_MasterProctor (MasterName,Term,isMid,isFin,MidStart,MidEnd,FinStart,FinEnd,DateEntered)"
        strSQL += " values('" & string0 & "'," & string1 & ",0,0,'1/1/2000','1/1/2000','1/1/2000','1/1/2000','" & Now() & "')"



        Response.Write(strSQL & "  ---insertOL_MasterProctor<br>")
        ' Insert into OL_Catalog (CatalogName, Title, Term_Offering, Credits, Status)
        ...
        Catch
            Response.Write("failed to create a new OL_MasterProctor record <br>")
        Finally
            If myConnection.State = ConnectionState.Open Then
                myConnection.Close()
            End If
