<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SelectTask.aspx.vb" Inherits="RadDesigner.SelectTask" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            ...
            <tr class="newStyle9">
                <td colspan="2">
                    <h1 class="auto-style5">Accept Task&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnReturn" runat="server" BackColor="#99FFCC" Font-Bold="True" Text="Return to Task List" />
                    </h1>
                </td>
            </tr>
            <tr>
            ...
            <tr class="newStyle9">
                <td >
        <asp:Button ID="Button1" runat="server" BackColor="#CC0000" Font-Bold="True" Font-Size="Large" ForeColor="White" Text="Accept Task" />
                </td>
                <td "></td>
            </tr>
        </table>
