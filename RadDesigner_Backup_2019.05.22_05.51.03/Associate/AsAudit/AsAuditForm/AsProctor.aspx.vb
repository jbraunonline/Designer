...
Public Class AsProctor1
    ...
    Protected Function DoesAuditProctorExist(ByVal myID As String, ByVal mycourse As String) As Boolean
        ...
        strsql = "Select  MasterName from OL_AuditProctor Where MasterName='" & mycourse & "'"
    ...
    Protected Sub DoesExamExist(ByVal myMaster As String)
        ...
        If dr.HasRows Then
            ...
            End While
        Else
            Response.Write("<font color=red>No Exam record exists for this course.  Please see administrator.</font>")
            Response.End()
        End If
    ...
    Protected Sub getData()
        ...
        If dr.HasRows Then
            While dr.Read()
                If Not dr("DateEntered") Is DBNull.Value Then
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Response.Redirect("asproctor.aspx")
    End Sub
