<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="RadDesigner._default1" %>
...
                    <Tabs>
            <telerik:RadTab runat="server" Text="NewMasterShells"  Visible="True" Selected="True">
            </telerik:RadTab>
            <telerik:RadTab runat="server" Text="Create Audit" visible="False" >
            </telerik:RadTab>
...
                ContentUrl="admin/newmastershells.aspx" Font-Bold="True" Font-Names="Arial">
                   </telerik:RadPageView>
